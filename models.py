...
class BulkLoadPreviewCodesRequest(BaseModel):
    """Request model for bulk loading preview codes"""
    codes: List[str] = Field(..., description="List of preview codes to create")
    replace_existing: bool = Field(default=False, description="Whether to replace existing codes")


class BulkLoadPreviewCodesResponse(BaseModel):
    """Response model for bulk loading preview codes"""
    success: bool = Field(..., description="Whether the operation was successful")
    loaded_count: int = Field(..., description="Number of codes successfully loaded")
    skipped_count: int = Field(..., description="Number of codes skipped")
    errors: Optional[List[str]] = Field(default=None, description="List of errors encountered")
    message: str = Field(..., description="Summary message")


class ResetPreviewCodesRequest(BaseModel):
    """Request model for resetting preview codes"""
    reset_type: str = Field(default="mark_unused", description="Type of reset: 'mark_unused' or 'delete_all'")
    confirm: bool = Field(..., description="Confirmation flag for destructive operation")


class ResetPreviewCodesResponse(BaseModel):
    """Response model for resetting preview codes"""
    success: bool = Field(..., description="Whether the operation was successful")
    affected_count: int = Field(..., description="Number of codes affected")
    message: str = Field(..., description="Summary message")


class PreviewCodeStatsResponse(BaseModel):
    """Response model for preview code statistics"""
    total_codes: int = Field(..., description="Total number of preview codes")
    used_codes: int = Field(..., description="Number of used codes")
